    ...
    <section class="search-cont">
        <div class="container mb-3">
            ...
            <form class="mb-2 mt-4" method="GET" action="/buscar">
                <div class="form-row">
                    <div class="col-12 col-md-8 offset-md-2 mb-2 mb-md-0 search-input">
            ...
            <small class="offset-md-2">¿Buscás una receta en especial?<a href="/categorias" class="ml-1">Ingresá aquí</a></small>
        </div>
    </section>
