...
<div class="col-md-4 col-sm-6 mb-3 small-card">
    <div class="card">
        ...
        @endunless
        <div class="card-body">
            <span class="recipe-rate"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i></span>
        ...
        <div class="card-footer d-flex">
            <small class="text-muted">Por <a href="#" class="recipe-creator">{{$recipe->user->name}}</a></small>
